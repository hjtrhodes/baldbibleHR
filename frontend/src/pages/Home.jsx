            ...
            <div>
                ...
                {!showLongMessage && (
                        <>
                            ...
                            <button className='showmessagebutton' onClick={handleToggleMessage}>Can't see any pictures? - Click Here</button>
                        </>
                )}
                {showLongMessage && (
                    <div className='rendercontainer'>
                        <>
                            ...
                            <p className='rendermessage'>
                                If you can see pictures but clicked the button anyway - ignore this message - the server is running, you're good to go!
                            </p> 
                            <button className='messagebutton' onClick={handleToggleMessage}>Hide Message</button>
                        </>
                    </div>
                )}
            </div>
