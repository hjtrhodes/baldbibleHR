...
module.exports = (req, res, next) => {
  // export a function that takes the request, response, and next arguments
  try {
    ...
    // if the try block throws an error, execute the following code
    res.status(401).json({
      // return a 401 Unauthorized error and a JSON object
